...
filename=sprintf('flows_%.0fpercLLload_100kBshuffle_1sec_%dhosts',100*loadfrac0,H);
...
% make the flows: (all bulk flows start 100 ms into the simulation)
start_times=100000000; % nanoseconds
