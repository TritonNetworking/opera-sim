...
fname=sprintf('../sim/FCT_3to1_pfab_cwnd30_%dperc.txt',perc);
matname=sprintf('FCT_%dperc.mat',perc);

% fname=sprintf('../sim/FCT_3to1_pfab_cwnd30_%dperc_prio_%d.txt',perc,run);
% matname=sprintf('FCT_%dperc_prio_%d.mat',perc,run);
