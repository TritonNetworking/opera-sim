...
% fname=sprintf('../sim/FCT_exp_pfab_cwnd30_q46_%dperc_VLB0.txt',perc);
% matname=sprintf('FCT_%dperc_VLB0.mat',perc);

fname=sprintf('../sim/FCT_exp_pfab_cwnd30_q46_%dperc_VLB0_prio_%d.txt',perc,run);
matname=sprintf('FCT_%dperc_VLB0_prio_%d.mat',perc,run);

savemat=1; % flag to save .mat file
...
plot(flowsize,cumsum(Nfiltered_flows)/Nrecorded_flows);
ax=gca;
ax.XScale='log';
