...
CASE=2;
loadfrac0=.1; % fraction of theoretically possible load
...
filename=sprintf('flows_%.0fpercLoad_10sec_%dhosts_u%d_prio_%d',100*loadfrac0,H,u,iter);
