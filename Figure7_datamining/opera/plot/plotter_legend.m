...
for a=2:length(loads)
    ...
    plot(flowsize(1:13),1e3*FCTs99{a}(1:13),'-k','linewidth',1,'color',h(a+1).Color);
    plot(flowsize(14:17),1e3*FCTs99{a}(14:17),'-k','linewidth',1,'color',h(a+1).Color);
    plot(flowsize(13:14),1e3*FCTs99{a}(13:14),'--k','linewidth',1,'color',h(a+1).Color);
...
set(gca,'position',[-340 58.8214 318.1857 232.5536]);
...
print(fig,'fcts_opera_1_legend','-dpdf')
