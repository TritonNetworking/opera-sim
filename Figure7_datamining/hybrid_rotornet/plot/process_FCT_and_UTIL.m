...
% fname=sprintf('../sim/FCT_6to1_cwnd30_%dperc_prio_%d.txt',perc,run);
% matname=sprintf('FCT_%dperc_prio.mat',perc);

fname=sprintf('../sim/FCT_pfab_cwnd20_%dperc_RLBonly.txt',perc);
matname=sprintf('FCT_%dperc_RLBonly.mat',perc);

savemat=1; % flat to save .mat file
