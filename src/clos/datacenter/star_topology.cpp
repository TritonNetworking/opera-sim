...
// constructor for class `StarTopology`
StarTopology::StarTopology(Logfile* lg, EventList* ev, FirstFit* fit){
  logfile = lg;
  eventlist = ev;
  ff = fit;
  
  _no_of_nodes = NSRV; // `_no_of_nodes is private variable of class `StarTopology`
...
void StarTopology::init_network(){
  ...
  // initialize all in/out pipes and in/out queues to NULL
